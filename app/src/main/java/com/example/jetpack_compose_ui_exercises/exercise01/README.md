...
Zacznij od kolumny ze verticalArrangement = Arrangement.Center.

Przy polach tekstowych użyj modifier = Modifier.fillMaxWidth().

Przycisk LOGIN powinien być szeroki (również fillMaxWidth).
